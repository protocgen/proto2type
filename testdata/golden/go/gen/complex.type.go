...
func (o *Organization) FromProto(pb *pb.Organization) {
	...
	if len(pb.Departments) > 0 {
		o.Departments = make([]*OrganizationDepartment, len(pb.Departments))
...
// FromProto populates from a protobuf message.
func (o *OrganizationDepartment) FromProto(pb *pb.Organization_Department) {
	if pb == nil {
		return
	}
	o.Name = pb.Name
	if len(pb.Teams) > 0 {
		o.Teams = make([]*OrganizationDepartmentTeam, len(pb.Teams))
...
// FromProto populates from a protobuf message.
func (o *OrganizationDepartmentTeam) FromProto(pb *pb.Organization_Department_Team) {
	if pb == nil {
		return
	}
	o.Name = pb.Name
...
// FromProto populates from a protobuf message.
func (e *Event) FromProto(pb *pb.Event) {
	if pb == nil {
		return
	}
	e.ID = pb.Id
