...
export const UserSchema = /* @__PURE__ */ z.object({
  ...
  scores: z.record(z.string().refine(k => k !== '__proto__' && k !== 'constructor' && k !== 'prototype'), z.union([z.string().max(100).regex(/^-?\d+$/), z.bigint()]).pipe(z.coerce.bigint()).nullable()).default(() => ({})),
